...
const createAdmin = async () => {
  try {
    ...
    const ADMIN_NAME = process.env.ADMIN_NAME || "FoodieHub Admin";
    const ADMIN_EMAIL = process.env.ADMIN_EMAIL || "admin@foodiehub.com";
    ...
    console.log(
      "Note: keep the credentials safe and change the password after first login.",
    );
    process.exit(0);
  } catch (error) {
